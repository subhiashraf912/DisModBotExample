...
export default class FaseMessageSpamEvent extends DisModBaseEvent {
      constructor() {
            super('fastMessageSpam');
      }
      ...
      async run(client: DiscordClient, message: Message) {
            ...
            if (config?.autoModerator.antiFastMessageSpam.enabled) {
                  if (config?.autoModerator.antiFastMessageSpam.warnMember) {
                        ...
                        const newWarn: warn = {
                              reason: 'Sending fast messages (spamming)!',
                              date: Date.now(),
                  ...
                  if (config?.autoModerator.antiFastMessageSpam.deleteMessage) {
