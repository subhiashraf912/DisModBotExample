...
export default class EnableAntiEmojiSpamCommand extends BaseCommand {
      constructor() {
            super({
                  name: 'enable-anti-emoji-spam',
                  category: 'AutoModerator',
                  aliases: ['enableantiemojispam'],
                  description:
                        'Using this command you can enable the anti emoji spam system using DisMod module!',
      ...
      async run(client: DiscordClient, message: Message, args: Array<string>) {
            ...
            if (autoModerator.antiEmojiSpam.enabled === true)
                  return message.channel.send(
                        'The anti emoji spam system is already enabled!',
                  );
            autoModerator.antiEmojiSpam.enabled = true;
            ...
            await message.channel.send(
                  'The anti emoji spam system has been enabled!',
            );
      }
}
