...
export default class DisableAntiFastMessageSpamCommand extends BaseCommand {
      constructor() {
            super({
                  name: 'disable-anti-fast-message-spam-delete',
      ...
      async run(client: DiscordClient, message: Message, args: Array<string>) {
            ...
            if (autoModerator.antiFastMessageSpam.deleteMessage === false)
                  return message.channel.send(
                        'lazy to type :v replace this with your message',
                  );
            autoModerator.antiFastMessageSpam.deleteMessage = false;
