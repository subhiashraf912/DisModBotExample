...
export default class EnableAntiFastMessageSpamCommand extends BaseCommand {
      constructor() {
            super({
                  name: 'enable-anti-fast-message-spam-message-delete',
      ...
      async run(client: DiscordClient, message: Message, args: Array<string>) {
            ...
            if (autoModerator.antiFastMessageSpam.deleteMessage === true)
                  return message.channel.send(
                        'lazy to type :v replace this with your message',
                  );
            autoModerator.antiFastMessageSpam.deleteMessage = true;
